...
void List_Dispose( List *list ) {
	...
	ListElementPtr next_element;
	
	while(element != NULL){
		next_element = element->nextElement;
		free(element);
		element = next_element;
	} //disposing list from first element until empty
...
void List_DeleteAfter( List *list ) {
	...
	ListElementPtr tmp = list->activeElement->nextElement;  //temporalily store next element of active to remove it
...
void List_InsertAfter( List *list, int data ) {
	...
	// else{
	// 	element->nextElement = list->activeElement->nextElement->nextElement;
	// 	list->activeElement->nextElement = element;
	// }
